...
interface EditCommutingMemberModalProps {
  member: CommutingMember;
  onClose: () => void;
  onSave: (member: CommutingMember) => Promise<void>;
}

const EditCommutingMemberModal: React.FC<EditCommutingMemberModalProps> = ({ member, onClose, onSave }) => {
  const [formData, setFormData] = useState<CommutingMember>(member);
    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-4 border-b">
          <h3 className="text-xl font-semibold text-gray-800">ویرایش عضو تردد</h3>
...
export default EditCommutingMemberModal;